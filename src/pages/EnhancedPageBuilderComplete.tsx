...
export default function EnhancedPageBuilderComplete() {
                                        ...
                                        <div className="p-4 bg-gray-50 rounded-lg">
                                          ...
                                          <Button
                                            className={`pointer-events-none transition-all ${
                                              block.content.effect === "scale"
                                                ? "hover:scale-105"
                                                : ""
                                            } ${
                                              block.content.effect === "bounce"
                                                ? "hover:animate-bounce"
                                                : ""
                                            } ${
                                              block.content.effect === "pulse"
                                                ? "hover:animate-pulse"
                                                : ""
                                            } ${
                                              block.content.effect === "glow"
                                          ...
                                          (item: any, itemIndex: number) => (
                                            ...
                                            >
                                              <Button
                                                variant="outline"
                                                size="sm"
                                                className="w-16 h-10 text-lg p-0 flex items-center justify-center hover:bg-blue-50"
                                                onClick={() => {
                                                  setEditingEmojiItem({
                                                    blockId: block.id,
                                                    itemIndex: itemIndex,
            ...
            <div className="space-y-3">
              {Object.entries(EMOJI_CATEGORIES).map(([key, category]) => (
                <div key={key}>
                  ...
                  <div className="grid grid-cols-8 gap-2 p-2 border rounded-lg">
              ...
              >
                <CardContent className="p-4">
                  <div className="text-center space-y-3">
                    ...
                    >
                      {template.config.emoji} {template.config.text}
                    </Button>
                  </div>
                </CardContent>
              </Card>
